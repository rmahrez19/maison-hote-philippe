...
export default function QuoteBreak() {
  return (
    <section className="relative flex h-[70vh] min-h-[480px] w-full items-center justify-center overflow-hidden">
      <Image
        src="/photos/seine-aube.jpg"
        alt="Le lever du jour sur la Seine, vu depuis la maison flottante"
        fill
        sizes="100vw"
        className="object-cover"
      />
      <div className="absolute inset-0 bg-stone-950/[0.52]" />
      <blockquote className="relative max-w-2xl px-6 text-center">
        <Reveal>
          ...
          <footer className="mt-6 text-[11px] font-light uppercase tracking-[0.25em] text-stone-100/85">
            Avis client — 9,5 / 10
          </footer>
        </Reveal>
      </blockquote>
